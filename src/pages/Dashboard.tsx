  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-1">Track your job applications and career progress</p>
      </div>
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-semibold text-gray-900 mt-2">{stats.interviewing}</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-semibold text-gray-900 mt-2">{stats.offers}</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-semibold text-gray-900 mt-2">{stats.rejected}</p>
            </div>
        ...
        <div className="overflow-x-auto">
          {filteredJobs.length === 0 ? (
            <div className="p-8 text-center text-gray-500">
              {searchQuery ? 'No applications match your search' : 'No applications yet. Start by adding your first job application!'}
            </div>
          ) : (
