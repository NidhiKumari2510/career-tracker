...
const ROADMAP_STORAGE_KEY = "dsaRoadmapProgress";
...
export default function DSARoadmap() {
  ...
  function loadProgress() {
    ...
    try {
      const stored = getFromStorage<string[]>(ROADMAP_STORAGE_KEY, []);
      setCompletedTopics(new Set(stored));
    } catch (err) {
      console.error("Error loading roadmap progress from localStorage:", err);
    } finally {
      setLoading(false);
    }
  }
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-1">
          Track your Data Structures & Algorithms learning progress
        </p>
      </div>
